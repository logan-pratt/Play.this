...
- (BOOL)loadWithPlayThisId:(NSString *)playlistId {
  return [self loadWithPlayThisId:playlistId playerVars:nil];
}
...
- (void)cuePlayThisByPlaylistId:(NSString *)playlistId
  ...
  [self cuePlayThis:playlistIdString
                 index:index
...
- (void)cuePlayThisByVideos:(NSArray *)videoIds
               ...
               startSeconds:(float)startSeconds
           suggestedQuality:(YTPlaybackQuality)suggestedQuality {
  [self cuePlayThis:[self stringFromVideoIdArray:videoIds]
                 index:index
          startSeconds:startSeconds
      suggestedQuality:suggestedQuality];
}
...
- (void)loadPlayThisByPlaylistId:(NSString *)playlistId
                ...
                suggestedQuality:(YTPlaybackQuality)suggestedQuality {
  NSString *playlistIdString = [NSString stringWithFormat:@"'%@'", playlistId];
  [self loadPlayThis:playlistIdString
                 index:index
          startSeconds:startSeconds
      suggestedQuality:suggestedQuality];
}
...
- (void)loadPlayThisByVideos:(NSArray *)videoIds
                ...
                startSeconds:(float)startSeconds
            suggestedQuality:(YTPlaybackQuality)suggestedQuality {
  [self loadPlayThis:[self stringFromVideoIdArray:videoIds]
                 index:index
          startSeconds:startSeconds
      suggestedQuality:suggestedQuality];
}
...
#pragma mark - PlayThis methods

- (NSArray *)playlist {
  NSString *returnValue = [self stringFromEvaluatingJavaScript:@"player.getPlayThis();"];
...
- (int)playlistIndex {
  NSString *returnValue = [self stringFromEvaluatingJavaScript:@"player.getPlayThisIndex();"];
 ...
 */
- (void)cuePlayThis:(NSString *)cueingString
               index:(int)index
        startSeconds:(float)startSeconds
    suggestedQuality:(YTPlaybackQuality)suggestedQuality {
  ...
  NSNumber *startSecondsValue = [NSNumber numberWithFloat:startSeconds];
  NSString *qualityValue = [YTPlayerView stringForPlaybackQuality:suggestedQuality];
  NSString *command = [NSString stringWithFormat:@"player.cuePlayThis(%@, %@, %@, '%@');",
 ...
 * @return The result of cueing the playlist.
 */
- (void)loadPlayThis:(NSString *)cueingString
               index:(int)index
        startSeconds:(float)startSeconds
    suggestedQuality:(YTPlaybackQuality)suggestedQuality {
  NSNumber *indexValue = [NSNumber numberWithInt:index];
  NSNumber *startSecondsValue = [NSNumber numberWithFloat:startSeconds];
  NSString *qualityValue = [YTPlayerView stringForPlaybackQuality:suggestedQuality];
  NSString *command = [NSString stringWithFormat:@"player.loadPlayThis(%@, %@, %@, '%@');",
      cueingString, indexValue, startSecondsValue, qualityValue];
    NSLog(@"%@", command);
  [self stringFromEvaluatingJavaScript:command];
}
